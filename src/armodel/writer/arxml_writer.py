...
from armodel.models.M2.AUTOSARTemplates.SWComponentTemplate.Components.InstanceRefs import ParameterInAtomicSWCTypeInstanceRef, VariableInAtomicSWCTypeInstanceRef
