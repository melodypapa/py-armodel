...
class TimingDescriptionEventChain(TimingDescription):
    ...
    # [x] getIsPipeliningPermitted     [x] impl  [x] docstring  [x] test  [—] reader  [x] writer  R23-11
    # [x] setIsPipeliningPermitted     [x] impl  [x] docstring  [x] test  [x] reader  [—] writer  R23-11
    ...
    # [x] addSegmentRef                [x] impl  [x] docstring  [x] test  [x] reader  [—] writer  R23-11
    # [x] getSegmentRefs               [x] impl  [x] docstring  [x] test  [—] reader  [x] writer  R23-11
    # [x] getStimulusRef               [x] impl  [x] docstring  [x] test  [—] reader  [x] writer  R23-11
    # [x] setStimulusRef               [x] impl  [x] docstring  [x] test  [x] reader  [—] writer  R23-11
    ...
    def addSegmentRef(self, value: Optional[RefType]) -> "TimingDescriptionEventChain":
        """A composed event chain consists of an arbitrary number of sub-chains. A None value is a no-op."""
        if value is not None:
