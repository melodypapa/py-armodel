...
class InstantiationDataDefProps(ARObject, VariationPointCapable):
    ...
    # [x] getParameterInstance  [x] impl  [x] docstring  [x] test  [—] reader  [x] writer  R23-11
    # [x] setParameterInstance  [x] impl  [x] docstring  [x] test  [x] reader  [—] writer  R23-11
    ...
    # [x] getVariableInstance   [x] impl  [x] docstring  [x] test  [—] reader  [x] writer  R23-11
    # [x] setVariableInstance   [x] impl  [x] docstring  [x] test  [x] reader  [—] writer  R23-11
    ...
    def setParameterInstance(self, value: Optional[AutosarParameterRef]) -> InstantiationDataDefProps:
        """This reference identifies the particular DataPrototype (defined in the context of a composite ParameterDataPrototype) on which the swDataDefProps shall be applied. A None value is a no-op and does not overwrite an existing parameterInstance."""
    ...
    def setSwDataDefProps(self, value: Optional[SwDataDefProps]) -> InstantiationDataDefProps:
        """These are the particular data definition properties which shall be applied A None value is a no-op and does not overwrite an existing swDataDefProps."""
        if value is not None:
    ...
    def setVariableInstance(self, value: Optional[AutosarVariableRef]) -> InstantiationDataDefProps:
        """This reference identifies the particular DataPrototype (defined in the context of a composite VariableDataPrototype) on which the swDataDefProps shall be applied. A None value is a no-op and does not overwrite an existing variableInstance."""
        if value is not None:
