...
from armodel.models.M2.AUTOSARTemplates.GenericStructure.GeneralTemplateClasses.PrimitiveTypes import ARBoolean, AREnum, ARNumerical, ARPositiveInteger, Boolean, PositiveInteger, RefType, TimeValue
