...
class ComponentInSystemInstanceRef(AtpInstanceRef):
    ...
    def setBaseRef(self, value: Optional[RefType]) -> "ComponentInSystemInstanceRef":
        """Stereotypes: atpDerived Tags: xml.sequenceOffset=10
        A None value is a no-op and does not overwrite an existing baseRef."""
        if value is not None:
            self.baseRef = value
    ...
    def addContextComponentRef(self, value: Optional[RefType]) -> "ComponentInSystemInstanceRef":
        """Tags: xml.sequenceOffset=30
    ...
    def setContextCompositionRef(self, value: Optional[RefType]) -> "ComponentInSystemInstanceRef":
        """Tags: xml.sequenceOffset=20
    ...
    def setTargetComponentRef(self, value: Optional[RefType]) -> "ComponentInSystemInstanceRef":
        """Tags: xml.sequenceOffset=40
