...
class DocumentationBlock(ARObject):
    ...
    # ===== Pythonic properties (CODING_RULE_V2_00016) =====
        ...
        self._defList: RefType = None

    @property
    def def_list(self) -> RefType:
        """Get defList (Pythonic accessor)."""
        return self._defList

    @def_list.setter
    def def_list(self, value: RefType) -> None:
        """
    ...
    @property
    def list(self) -> RefType:
        """Get list (Pythonic accessor)."""
        return self._list

    @list.setter
    def list(self, value: RefType) -> None:
        """
