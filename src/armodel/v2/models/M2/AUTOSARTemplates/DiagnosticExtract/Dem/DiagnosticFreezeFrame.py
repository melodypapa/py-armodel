...
class DiagnosticFreezeFrame(DiagnosticCommonElement):
    ...
    def custom_trigger(self, value: Optional["String"]) -> None:
        ...
        if not isinstance(value, String):
            raise TypeError(
                f"customTrigger must be String or None, got {type(value).__name__}"
            )
    ...
    def record_number(self, value: Optional["PositiveInteger"]) -> None:
        ...
        if not isinstance(value, PositiveInteger):
            raise TypeError(
                f"recordNumber must be PositiveInteger or None, got {type(value).__name__}"
            )
    ...
    def update(self, value: Optional["Boolean"]) -> None:
        ...
        if not isinstance(value, Boolean):
            raise TypeError(
                f"update must be Boolean or None, got {type(value).__name__}"
            )
        self._update = value
