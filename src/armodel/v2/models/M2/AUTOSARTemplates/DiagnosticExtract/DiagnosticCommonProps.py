...
class DiagnosticCommonProps(ARObject):
    ...
    def reset_confirmed(self, value: Optional["Boolean"]) -> None:
        ...
        if not isinstance(value, Boolean):
            raise TypeError(
                f"resetConfirmed must be Boolean or None, got {type(value).__name__}"
            )
    ...
    def reset_pending_bit(self, value: Optional["Boolean"]) -> None:
        ...
        if not isinstance(value, Boolean):
            raise TypeError(
                f"resetPendingBit must be Boolean or None, got {type(value).__name__}"
            )
    ...
    def response_on_all(self, value: Optional["Boolean"]) -> None:
        ...
        if not isinstance(value, Boolean):
            raise TypeError(
                f"responseOnAll must be Boolean or None, got {type(value).__name__}"
            )
    ...
    def response_on(self, value: Optional["Boolean"]) -> None:
        ...
        if not isinstance(value, Boolean):
            raise TypeError(
                f"responseOn must be Boolean or None, got {type(value).__name__}"
            )
