...
class TagWithOptionalValue(ARObject):
    ...
    def key(self, value: Optional["String"]) -> None:
        ...
        if not isinstance(value, String):
            raise TypeError(
                f"key must be String or None, got {type(value).__name__}"
            )
        self._key = value
    ...
    def sequence_offset(self, value: Optional["Integer"]) -> None:
        ...
        if not isinstance(value, Integer):
            raise TypeError(
                f"sequenceOffset must be Integer or None, got {type(value).__name__}"
            )
    ...
    def value(self, value: Optional["String"]) -> None:
        ...
        if not isinstance(value, String):
            raise TypeError(
                f"value must be String or None, got {type(value).__name__}"
            )
        self._value = value
