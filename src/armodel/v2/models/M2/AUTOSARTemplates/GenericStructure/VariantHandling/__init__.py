...
class PostBuildVariantCriterion(ARObject):
    ...
    def setCriterionName(self, value: String) -> "PostBuildVariantCriterion":
        if value is not None:
    ...
    def setCriterionValue(self, value: String) -> "PostBuildVariantCriterion":
        if value is not None:
...
class PostBuildVariantCriterionValue(ARObject):
    ...
    def setValue(self, value: String) -> "PostBuildVariantCriterionValue":
        if value is not None:
            self.value = value
        return self
...
class SwSystemconstantValueSet(ARObject):
    ...
    def setConstantName(self, value: String) -> "SwSystemconstantValueSet":
        if value is not None:
    ...
    def addConstantValue(self, value: String) -> "SwSystemconstantValueSet":
        if value is not None:
    ...
    def setConstantRef(self, value: RefType) -> "SwSystemconstantValueSet":
        if value is not None:
