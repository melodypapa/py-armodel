...
class InstantiationDataDefProps(ARObject):
    ...
    # ===== Pythonic properties (CODING_RULE_V2_00016) =====
        ...
        self._parameter: RefType = None

    @property
    def parameter(self) -> RefType:
        """Get parameter (Pythonic accessor)."""
        return self._parameter

    @parameter.setter
    def parameter(self, value: RefType) -> None:
        """
    ...
    def sw_data_def(self, value: Optional["SwDataDefProps"]) -> None:
        ...
        self._variableInstance: RefType = None

    @property
    def variable_instance(self) -> RefType:
        """Get variableInstance (Pythonic accessor)."""
        return self._variableInstance

    @variable_instance.setter
    def variable_instance(self, value: RefType) -> None:
        """
