...
class BusMirrorCanIdRangeMapping(ARObject):
    ...
    def source_can_id(self, value: Optional["PositiveInteger"]) -> None:
        ...
        if not isinstance(value, (PositiveInteger, str)):
            raise TypeError(
                f"sourceCanId must be PositiveInteger or str or None, got {type(value).__name__}"
            )
...
class BusMirrorChannelMappingCan(BusMirrorChannelMapping):
    ...
    def mirror_status(self, value: Optional["PositiveInteger"]) -> None:
        ...
        if not isinstance(value, (PositiveInteger, str)):
            raise TypeError(
                f"mirrorStatus must be PositiveInteger or str or None, got {type(value).__name__}"
            )
...
class BusMirrorChannelMappingUserDefined(BusMirrorChannelMapping):
    ...
    Package: M2::AUTOSARTemplates::SystemTemplate::BusMirror::BusMirrorChannelMappingUserDefined
...
Eunumeration that defines the supported bus mirroring protocol options) with two literals. Aggregated by BusMirrorChannelMapping.mirroringProtocol

Package: M2::AUTOSARTemplates::SystemTemplate::BusMirror
    """
    # mirroringProtocol is not used version1 version1 of the mirroringProtocol is used
    none = "0"
