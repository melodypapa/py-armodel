...
class PncMapping(Describable):
    ...
    def dynamic_pnc(self) -> List[RefType]:
        ...
        self._ident: RefType = None

    @property
    def ident(self) -> RefType:
    ...
    def pnc_identifier(self, value: Optional["PositiveInteger"]) -> None:
        ...
        if not isinstance(value, PositiveInteger):
            raise TypeError(
                f"pncIdentifier must be PositiveInteger or None, got {type(value).__name__}"
            )
    ...
    def pnc_wakeup(self, value: Optional["Boolean"]) -> None:
        ...
        if not isinstance(value, Boolean):
            raise TypeError(
                f"pncWakeup must be Boolean or None, got {type(value).__name__}"
            )
