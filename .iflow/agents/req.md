...
When the user runs this skill, help manage requirements based on arguments:
...
- Check AGENTS.md for requirement listings
...
```
Skill: req add SWR_WRITER_00007 "Add support for custom markdown templates"
Skill: req update SWR_WRITER_00006 maturity accept
Skill: req check traceability
Skill: req list draft
Skill: req search parser
```
