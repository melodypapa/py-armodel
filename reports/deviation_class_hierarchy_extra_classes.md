...
| + EXTRA | AUTOSARTemplates.CommonStructure.ImplementationDataTypes.ArrayImplPolicyEnum | **Actual:**<br>Parent: AREnum<br>Type: Concrete | Class exists but not documented |
| + EXTRA | AUTOSARTemplates.CommonStructure.ImplementationDataTypes.ArraySizeSemanticsEnum | **Actual:**<br>Parent: AREnum<br>Type: Concrete | Class exists but not documented |
...
| + EXTRA | AUTOSARTemplates.SystemTemplate.Fibex.FibexCore.CoreTopology.CanCluster | **Actual:**<br>Parent: AbstractCanCluster<br>Type: Concrete | Class exists but not documented |
| + EXTRA | AUTOSARTemplates.SystemTemplate.Fibex.Fibex4Can.CanTopology.CanCommunicationController | **Actual:**<br>Parent: AbstractCanCommunicationController<br>Type: Concrete | Class exists but not documented |
...
| + EXTRA | AUTOSARTemplates.CommonStructure.Implementation.DependencyUsageEnum | **Actual:**<br>Parent: AREnum<br>Type: Concrete | Class exists but not documented |
...
| + EXTRA | AUTOSARTemplates.CommonStructure.ServiceNeeds.DiagnosticDenominatorConditionEnum | **Actual:**<br>Parent: AREnum<br>Type: Concrete | Class exists but not documented |
| + EXTRA | AUTOSARTemplates.CommonStructure.ServiceNeeds.DiagnosticMonitorUpdateKindEnum | **Actual:**<br>Parent: AREnum<br>Type: Concrete | Class exists but not documented |
...
| + EXTRA | MSR.Documentation.TextModel.LanguageDataModel.LLongName | **Actual:**<br>Parent: LanguageSpecific<br>Type: Concrete | Class exists but not documented |
| + EXTRA | MSR.Documentation.TextModel.LanguageDataModel.LOverviewParagraph | **Actual:**<br>Parent: LanguageSpecific<br>Type: Concrete | Class exists but not documented |
| + EXTRA | MSR.Documentation.TextModel.LanguageDataModel.LParagraph | **Actual:**<br>Parent: LanguageSpecific<br>Type: Concrete | Class exists but not documented |
| + EXTRA | MSR.Documentation.TextModel.LanguageDataModel.LPlainText | **Actual:**<br>Parent: LanguageSpecific<br>Type: Concrete | Class exists but not documented |
| + EXTRA | AUTOSARTemplates.CommonStructure.Timing.TimingConstraint.LatencyTimingConstraint.LatencyConstraintTypeEnum | **Actual:**<br>Parent: AREnum<br>Type: Concrete | Class exists but not documented |
| + EXTRA | AUTOSARTemplates.CommonStructure.Timing.TimingConstraint.ExecutionOrderConstraint.LetDataExchangeParadigmEnum | **Actual:**<br>Parent: None<br>Type: Concrete | Class exists but not documented |
...
| + EXTRA | AUTOSARTemplates.SystemTemplate.Fibex.FibexCore.CoreTopology.LinCluster | **Actual:**<br>Parent: CommunicationCluster<br>Type: Concrete | Class exists but not documented |
| + EXTRA | AUTOSARTemplates.SystemTemplate.Fibex.Fibex4Lin.LinTopology.LinCommunicationController | **Actual:**<br>Parent: CommunicationController<br>Type: Abstract | Class exists but not documented |
| + EXTRA | AUTOSARTemplates.SystemTemplate.Fibex.Fibex4Lin.LinTopology.LinMaster | **Actual:**<br>Parent: LinCommunicationController<br>Type: Concrete | Class exists but not documented |
...
| + EXTRA | AUTOSARTemplates.CommonStructure.ServiceNeeds.MaxCommModeEnum | **Actual:**<br>Parent: AREnum<br>Type: Concrete | Class exists but not documented |
...
| + EXTRA | AUTOSARTemplates.CommonStructure.Implementation.ProgramminglanguageEnum | **Actual:**<br>Parent: AREnum<br>Type: Concrete | Class exists but not documented |
...
| + EXTRA | AUTOSARTemplates.CommonStructure.MeasurementCalibrationSupport.RptSupport.RptAccessEnum.RptAccessEnum | **Actual:**<br>Parent: None<br>Type: Concrete | Class exists but not documented |
| + EXTRA | AUTOSARTemplates.CommonStructure.MeasurementCalibrationSupport.RptSupport.RptEnablerImplTypeEnum.RptEnablerImplTypeEnum | **Actual:**<br>Parent: None<br>Type: Concrete | Class exists but not documented |
| + EXTRA | AUTOSARTemplates.CommonStructure.MeasurementCalibrationSupport.RptSupport.RptExecutionControlEnum.RptExecutionControlEnum | **Actual:**<br>Parent: None<br>Type: Concrete | Class exists but not documented |
| + EXTRA | AUTOSARTemplates.CommonStructure.MeasurementCalibrationSupport.RptSupport.RptPreparationEnum.RptPreparationEnum | **Actual:**<br>Parent: None<br>Type: Concrete | Class exists but not documented |
...
| + EXTRA | AUTOSARTemplates.CommonStructure.ServiceNeeds.ServiceProviderEnum | **Actual:**<br>Parent: AREnum<br>Type: Concrete | Class exists but not documented |
| + EXTRA | AUTOSARTemplates.CommonStructure.SignalServiceTranslation.SignalServiceTranslationControlEnum.SignalServiceTranslationControlEnum | **Actual:**<br>Parent: None<br>Type: Concrete | Class exists but not documented |
| + EXTRA | MSR.AsamHdo.Units.SingleLanguageUnitNames | **Actual:**<br>Parent: ARLiteral<br>Type: Concrete | Class exists but not documented |
...
| + EXTRA | AUTOSARTemplates.CommonStructure.ServiceNeeds.StorageConditionStatusEnum | **Actual:**<br>Parent: AREnum<br>Type: Concrete | Class exists but not documented |
...
| + EXTRA | MSR.DataDictionary.DataDefProperties.SwDataDefProps | **Actual:**<br>Parent: ARObject<br>Type: Concrete | Class exists but not documented |
...
| + EXTRA | MSR.DataDictionary.RecordLayout.SwRecordLayoutGroupContent | **Actual:**<br>Parent: ARObject<br>Type: Concrete | Class exists but not documented |
...
| + EXTRA | MSR.CalibrationData.CalibrationValue.SwValues | **Actual:**<br>Parent: ARObject<br>Type: Concrete | Class exists but not documented |
| + EXTRA | AUTOSARTemplates.CommonStructure.Timing.TimingConstraint.SynchronizationTiming.SynchronizationTypeEnum | **Actual:**<br>Parent: AREnum<br>Type: Concrete | Class exists but not documented |
...
| + EXTRA | AUTOSARTemplates.CommonStructure.ServiceNeeds.VerificationStatusIndicationModeEnum | **Actual:**<br>Parent: AREnum<br>Type: Concrete | Class exists but not documented |
