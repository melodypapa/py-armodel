...
12. [V2-Specific Coding Rules](#v2-specific-coding-rules)
...
The following coding rules apply specifically to V2 models (`src/armodel/models_v2/`).
...
**Description**: All V2 imports MUST use `armodel.models_v2` as the base module path.
...
**Description**: V2 models MUST NOT have circular imports at runtime. Use string annotations to prevent circular dependency evaluation.
...
**Example:**
```python
# In src/armodel/models_v2/__init__.py
__version__ = "2.0.0"
```
