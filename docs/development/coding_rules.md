...
12. [V2-Specific Coding Rules](#v2-specific-coding-rules) → See [V2 Model Coding Rules](coding_rules_v2.md)
...
The V2 model coding rules have been moved to a separate document for better organization and maintainability.

For V2-specific coding rules, see: **[V2 Model Coding Rules](coding_rules_v2.md)**

The V2 coding rules document covers:
...
**Quick Reference:**
- V2 models are located in `src/armodel/models_v2/`
- V2 tests are located in `tests/test_armodel/models_v2/`
- V2 validation scripts: `scripts/check_v2_coding_rules.py`, `scripts/fix_v2_coding_rules.py`
