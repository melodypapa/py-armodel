...
- [x] `Identifiable` (heritage-chain parent of CollectableElement/AtpBlueprint/AtpBlueprintable/ARPackage · **finished, UNSTAMPED per 9b user decision 2026-09-01** — variationPoint per-class placement outstanding · R23-11 markdown · AUTOSAR_FO_TPS_GenericStructureTemplate · Table 4.4, content md l.1650–1695)
