...
- [x] `MsrQueryResultChapter` (dependency · **added 2026-09-11 missing-class audit** · R23-11 markdown · AUTOSAR_FO_TPS_GenericStructureTemplate · Table 9.87 · member type of `MsrQueryChapter.msrQueryResultChapter` · **NOT in src** — class must be created when this row is synced) — verified R23-11 (commit pending)
