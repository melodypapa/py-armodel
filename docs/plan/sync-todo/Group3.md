...
- [x] `LGraphic` (tracker input · R23-11 markdown · AUTOSAR_FO_TPS_GenericStructureTemplate · Table 9.25 · after `Graphic` (aggr `graphic`) + `Map` (aggr `map`) · parent `LanguageSpecific` stamped ✓ · *(existing member)*) — verified R23-11 (commit 745227f3)
