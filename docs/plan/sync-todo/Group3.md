...
> - Dependency closure of the enums otherwise clear (AREnum → ARObject base); primitives not queued.
>
- [x] `AreaEnumNohref` (dependency · **added 2026-09-16 Area dependency audit** · R23-11 markdown · AUTOSAR_FO_TPS_GenericStructureTemplate · Table 9.18, p.301 · **NOT in src — created** · Package M2::MSR::Documentation::BlockElements::Figure → `Figure.py` · AREnum; literal nohref (XSD NOHREF) index 0 · aggregated by `Area.nohref` · queued dependency-first per Rule 0016.5) — verified R23-11 (commit pending)
