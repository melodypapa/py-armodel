...
- [ ] `OperationInSystemInstanceRef` (dependency of ClientIdDefinition, R23-11 markdown · AUTOSAR_CP_TPS_SystemTemplate · Table B.2, p.1002 · member type of `ClientIdDefinition.clientServerOperation` (iref) · added 2026-09-19 while syncing ClientIdDefinition)
