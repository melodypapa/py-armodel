...
- [x] EventOccurrenceKindEnum (member · markdown · AUTOSAR_CP_TPS_TimingExtensions.md, Table 3.56 · enum · consumed by SynchronizationTimingConstraint.eventOccurrenceKind · RELOCATED to leaf module Timing/TimingConstraint/SynchronizationTimingConstraint.py (Rule 0007 leaf form, all 3 classes direct members) · user review round 3: confirmed
  - [x] Step 1 — Sync members & description from spec
  - [x] Step 2 — Write model class unit test (Red)
  - [x] Step 3 — Implement model class (Green)
  - [x] Step 4 — Sync docstrings (wipe + rewrite)
...
- [x] ConfidenceInterval (member · markdown · AUTOSAR_CP_TPS_TimingExtensions.md, Table 3.65 · aggregated by ArbitraryEventTriggering.confidenceInterval) · user review round 2: confirmed
  - [x] Step 1 — Sync members & description from spec
  - [x] Step 2 — Write model class unit test (Red)
...
- [x] LetDataExchangeParadigmEnum (member · markdown · AUTOSAR_CP_TPS_TimingExtensions.md, Table 4.4 · enum · consumed by EOCExecutableEntityRefGroup.letDataExchangeParadigm) · user review round 2: confirmed
  - [x] Step 1 — Sync members & description from spec
  - [x] Step 2 — Write model class unit test (Red)
  - [x] Step 3 — Implement model class (Green)
  - [x] Step 4 — Sync docstrings (wipe + rewrite)
...
- [x] EOCExecutableEntityRef (member · markdown · AUTOSAR_CP_TPS_TimingExtensions.md, Table 3.72 · Base includes EOCExecutableEntityRefAbstract · component -> SwComponentPrototype iref (queued above), bswModuleInstance -> BswImplementation (already stamped), executable -> ExecutableEntity (already stamped)) · user review round 3: confirmed · commit 048e2e10 · user review: batch-confirmed
  - [x] Step 1 — Sync members & description from spec
  - [x] Step 2 — Write model class unit test (Red)
  ...
  - [x] Step 9 — Verify (9a passed: full suite green, ruff/flake8/black clean); 9b confirm + stamp deferred to batch
- [x] EOCEventRef (member · markdown · AUTOSAR_CP_TPS_TimingExtensions.md, Table 3.73 · Base includes EOCExecutableEntityRefAbstract · component -> SwComponentPrototype iref (queued above), bswModuleInstance -> BswImplementation (already stamped)) · user review round 3: confirmed · commit 048e2e10 · user review: batch-confirmed
  - [x] Step 1 — Sync members & description from spec
  - [x] Step 2 — Write model class unit test (Red)
  ...
  - [x] Step 9 — Verify (9a passed: full suite green, ruff/flake8/black clean); 9b confirm + stamp deferred to batch
- [x] TimingConstraint (input · markdown · AUTOSAR_CP_TPS_TimingExtensions.md, Table D.61 · abstract · Base = Traceable (queued above) · timingCondition -> TimingCondition (queued above)) · user review round 3: confirmed · commit 048e2e10 · user review: batch-confirmed
  - [x] Step 1 — Sync members & description from spec
  - [x] Step 2 — Write model class unit test (Red)
  ...
  - [x] Step 8 — Deviations: none blocking
  - [x] Step 9 — Verify (9a passed: full suite green, ruff/flake8/black clean); 9b confirm + stamp deferred to batch
- [x] SynchronizationTimingConstraint (member · markdown · AUTOSAR_CP_TPS_TimingExtensions.md, Table 3.54 · Base includes TimingConstraint · uses SynchronizationTypeEnum/EventOccurrenceKindEnum (queued above), MultidimensionalTime (already stamped) · scope/scopeEvent -> TimingDescriptionEventChain/TimingDescriptionEvent are Rule 0001.10 placeholders, not queued) · user review round 3: confirmed · now in leaf module Timing/TimingConstraint/SynchronizationTimingConstraint.py · commit 048e2e10 · user review: batch-confirmed
  - [x] Step 1 — Sync members & description from spec
  - [x] Step 2 — Write model class unit test (Red)
  ...
  - [x] Step 9 — Verify (9a passed: full suite green, ruff/flake8/black clean); 9b confirm + stamp deferred to batch
- [x] LatencyTimingConstraint (member · markdown · AUTOSAR_CP_TPS_TimingExtensions.md, Table 3.57 · Base includes TimingConstraint · uses LatencyConstraintTypeEnum (queued above), MultidimensionalTime (already stamped) · scope -> TimingDescriptionEventChain is a Rule 0001.10 placeholder, not queued) · user review round 3: confirmed · commit 048e2e10 · user review: batch-confirmed
  - [x] Step 1 — Sync members & description from spec
  - [x] Step 2 — Write model class unit test (Red)
  ...
  - [x] Step 9 — Verify (9a passed: full suite green, ruff/flake8/black clean); 9b confirm + stamp deferred to batch
- [x] OffsetTimingConstraint (member · markdown · AUTOSAR_CP_TPS_TimingExtensions.md, Table 3.66 · Base includes TimingConstraint · uses MultidimensionalTime (already stamped) · source/target -> TimingDescriptionEvent are Rule 0001.10 placeholders, not queued) · user review round 3: confirmed · commit 048e2e10 · user review: batch-confirmed
  - [x] Step 1 — Sync members & description from spec
  - [x] Step 2 — Write model class unit test (Red)
  ...
  - [x] Step 9 — Verify (9a passed: full suite green, ruff/flake8/black clean); 9b confirm + stamp deferred to batch
- [x] AgeConstraint (member · markdown · AUTOSAR_CP_TPS_TimingExtensions.md, Table 3.67 · Base includes TimingConstraint · uses MultidimensionalTime (already stamped) · scope -> TimingDescriptionEvent is a Rule 0001.10 placeholder, not queued) · user review round 3: confirmed · commit 048e2e10 · user review: batch-confirmed
  - [x] Step 1 — Sync members & description from spec
  - [x] Step 2 — Write model class unit test (Red)
...
- [x] PeriodicEventTriggering (member · markdown · AUTOSAR_CP_TPS_TimingExtensions.md, Table 3.60 · Base includes EventTriggeringConstraint · uses MultidimensionalTime (already stamped)) · commit da8cf5c2 · user review round 3: confirmed · commit 048e2e10 · user review: batch-confirmed
  - [x] Step 1 — Sync members & description from spec
  - [x] Step 2 — Write model class unit test (Red)
  ...
  - [x] Step 8 — Deviations: none blocking
  - [x] Step 9 — Verify (9a passed: full suite green, ruff/flake8/black clean); 9b confirm + stamp deferred to batch
- [x] SporadicEventTriggering (member · markdown · AUTOSAR_CP_TPS_TimingExtensions.md, Table 3.61 · Base includes EventTriggeringConstraint · uses MultidimensionalTime (already stamped)) · commit da8cf5c2 · user review round 3: confirmed · commit 048e2e10 · user review: batch-confirmed
  - [x] Step 1 — Sync members & description from spec
  - [x] Step 2 — Write model class unit test (Red)
  ...
  - [x] Step 8 — Deviations: none blocking
  - [x] Step 9 — Verify (9a passed: full suite green, ruff/flake8/black clean); 9b confirm + stamp deferred to batch
- [x] ConcretePatternEventTriggering (member · markdown · AUTOSAR_CP_TPS_TimingExtensions.md, Table 3.62 · Base includes EventTriggeringConstraint · uses MultidimensionalTime (already stamped)) · commit da8cf5c2 · user review round 3: confirmed · commit 048e2e10 · user review: batch-confirmed
  - [x] Step 1 — Sync members & description from spec
  - [x] Step 2 — Write model class unit test (Red)
  ...
  - [x] Step 8 — Deviations: none blocking
  - [x] Step 9 — Verify (9a passed: full suite green, ruff/flake8/black clean); 9b confirm + stamp deferred to batch
- [x] BurstPatternEventTriggering (member · markdown · AUTOSAR_CP_TPS_TimingExtensions.md, Table 3.63 · Base includes EventTriggeringConstraint · uses MultidimensionalTime (already stamped)) · commit da8cf5c2 · user review round 3: confirmed · commit 048e2e10 · user review: batch-confirmed
  - [x] Step 1 — Sync members & description from spec
  - [x] Step 2 — Write model class unit test (Red)
  ...
  - [x] Step 8 — Deviations: none blocking
  - [x] Step 9 — Verify (9a passed: full suite green, ruff/flake8/black clean); 9b confirm + stamp deferred to batch
- [x] ArbitraryEventTriggering (member · markdown · AUTOSAR_CP_TPS_TimingExtensions.md, Table 3.64 · Base includes EventTriggeringConstraint · confidenceInterval -> ConfidenceInterval (queued above)) · commit da8cf5c2 · user review round 3: confirmed · commit 048e2e10 · user review: batch-confirmed
  - [x] Step 1 — Sync members & description from spec
  - [x] Step 2 — Write model class unit test (Red)
...
- [x] TDEventBswModuleTypeEnum (enum · AUTOSAR_CP_TPS_TimingExtensions.md, Table 3.45 · consumed by TDEventBswModule.tdEventBswModuleType) · commit 784784c4 · user review: confirmed
  - [x] Step 1 — Sync members & description from spec (Enumeration header confirmed; Table 3.45; Note verbatim; 2 literals bswMEntryCalled/bswMEntryCallReturned, EnumerationLiteralIndex 0..1; NEW module TDEventBsw.py)
  - [x] Step 2 — Write model class unit test (Red) — test_TDEventBswModuleTypeEnum.py (3 tests)
  - [x] Step 3 — Implement model class (Green) — TDEventBswModuleTypeEnum(AREnum) in new module TDEventBsw.py; 2 literals + __init__ tuple
  - [x] Step 4 — Sync docstrings (wipe + rewrite) — class docstring + literal comments verbatim from Table 3.45
  - [x] Step 5 — N/A: standalone enum, round-trip via consuming class
  - [x] Step 6 — N/A: standalone enum, round-trip via consuming class
...
- [x] TDEventSwcInternalBehaviorReference (member · AUTOSAR_CP_TPS_TimingExtensions.md, Table 3.28 · referencedTDEventSwc -> TDEventSwc ref (RefType); Base includes TDEventSwc (queued above)) · commit ce350b80 · user review: confirmed
  ...
  - [x] Step 8 — Deviations
  - [x] Step 9 — Verify (9a) + confirm (9b)
- [x] TDEventCom (member · AUTOSAR_CP_TPS_TimingExtensions.md, Table 3.29 · abstract; ecuInstance -> EcuInstance ref (RefType)) · commit 09a18de9
  - [ ] Step 1 — Sync members & description from spec
  - [ ] Step 2 — Write model class unit test (Red)
  - [ ] Step 3 — Implement model class (Green)
  - [ ] Step 4 — Sync docstrings (wipe + rewrite)
  ...
  - [ ] Step 8 — Deviations
  - [ ] Step 9 — Verify (9a) + confirm (9b)
- [x] TDEventISignal (member · AUTOSAR_CP_TPS_TimingExtensions.md, Table 3.30 · iSignal/physicalChannel refs (RefType); tdEventType enum (queued above); Base includes TDEventCom (queued above)) · commit dec0e13d
  - [ ] Step 1 — Sync members & description from spec
  - [ ] Step 2 — Write model class unit test (Red)
  - [ ] Step 3 — Implement model class (Green)
  - [ ] Step 4 — Sync docstrings (wipe + rewrite)
  ...
  - [ ] Step 8 — Deviations
  - [ ] Step 9 — Verify (9a) + confirm (9b)
- [x] TDEventIPdu (member · AUTOSAR_CP_TPS_TimingExtensions.md, Table 3.32 · iPdu/physicalChannel refs (RefType); tdEventType enum (queued above); Base includes TDEventCom (queued above)) · commit 326afe4b
  - [ ] Step 1 — Sync members & description from spec
  - [ ] Step 2 — Write model class unit test (Red)
  - [ ] Step 3 — Implement model class (Green)
  - [ ] Step 4 — Sync docstrings (wipe + rewrite)
  ...
  - [ ] Step 8 — Deviations
  - [ ] Step 9 — Verify (9a) + confirm (9b)
- [x] TDEventFrame (member · AUTOSAR_CP_TPS_TimingExtensions.md, Table 3.34 · frame/physicalChannel refs (RefType); tdEventType enum (queued above); Base includes TDEventCom (queued above)) · commit b8e9195d
  - [ ] Step 1 — Sync members & description from spec
  - [ ] Step 2 — Write model class unit test (Red)
  - [ ] Step 3 — Implement model class (Green)
  - [ ] Step 4 — Sync docstrings (wipe + rewrite)
...
- [x] TDEventFrClusterCycleStart (member · AUTOSAR_CP_TPS_TimingExtensions.md, Table 3.40, p.71 · frCluster -> FlexrayCluster ref (RefType); Base includes TDEventCycleStart (queued above)) · commit 0934366c
  ...
  - [x] Step 4 — Sync docstrings (wipe + rewrite) — class + member notes verbatim from Table 3.40
  - [x] Step 5 — Write reader/writer round-trip test (Red) — test_parser_tdevents_com.py / test_writer_tdevents_com.py
  - [x] Step 6 — Update parser & writer (Green) — read/writeTDEventFrClusterCycleStart + FR-CLUSTER-REF + dispatch in read/writeTimingDescriptions
...
- [x] TDEventBswModule (member · AUTOSAR_CP_TPS_TimingExtensions.md, Table 3.44, p.75 · bswModuleEntry -> BswModuleEntry ref (RefType); type enum (TDEventBswModuleTypeEnum, queued above); Base includes TDEventBsw (queued above)) · commit 2c77658d
  ...
  - [x] Step 4 — Sync docstrings (wipe + rewrite) — class + member notes verbatim from Table 3.44
  - [x] Step 5 — Write reader/writer round-trip test (Red) — test_parser_tdevents_bswmodule.py / test_writer_tdevents_bswmodule.py
  - [x] Step 6 — Update parser & writer (Green) — read/writeTDEventBswModule + BSW-MODULE-ENTRY-REF + enum + dispatch in read/writeTimingDescriptions
...
- [x] TDEventComplex (member · markdown · AUTOSAR_CP_TPS_TimingExtensions.md, Table 3.48, p.78 · NO own attributes ("-" row verified at session start and against XSD TD-EVENT-COMPLEX empty sequence; occurrenceExpression comes from TimingDescriptionEvent base) · Base includes TimingDescriptionEvent (queued above)) · commit cfe56209
  ...
  - [x] Step 4 — Sync docstrings (wipe + rewrite) — class docstring verbatim from Table 3.48
  - [x] Step 5 — Write reader/writer round-trip test (Red) — test_parser_tdevents_complex.py / test_writer_tdevents_complex.py
  - [x] Step 6 — Update parser & writer (Green) — read/writeTDEventComplex (delegate to base) + dispatch in read/writeTimingDescriptions
...
- [x] TDEventSLLET (base · markdown · AUTOSAR_CP_TPS_TimingExtensions.md, Table D.57 · abstract · NO own attributes ("-" row) · Base includes TimingDescription/TimingDescriptionEvent (queued above)) · queued 2026-08-26: D.57 table found at session start (was treated as XSD-only header-only); required Base of TDEventSLLETPort · commit 007540a0
  ...
  - [x] Step 4 — Sync docstrings (wipe + rewrite) — new file; class docstring = spec Note verbatim (incl "Tags: atp.Status=draft")
  - [x] Step 5 — Write reader/writer round-trip test (Red) — test_parser_tdevents_sllet.py / test_writer_tdevents_sllet.py (concrete test subclass; TD-EVENT-SLLET element)
...
- [x] TDEventSLLETPort (member · markdown · AUTOSAR_CP_TPS_TimingExtensions.md, Table 3.49 · port -> PortPrototype ref (RefType); Base includes TDEventSLLET (queued above)) · commit 023238be · user review: confirmed
...
- [ ] TimingExtension (member · markdown · AUTOSAR_CP_TPS_TimingExtensions.md, Table D.65 · abstract · aggregates TimingCondition (TIMING-CONDITIONS) / timingGuarantee+timingRequirement -> polymorphic 12-subclass TimingConstraint dispatch (queued above); timingResource 0..1 -> TimingExtensionResource (queued above); timingDescription -> TIMING-DESCRIPTIONS family QUEUED above (TimingDescription/TimingDescriptionEvent bases + 23 concrete dispatch targets); Step 9b blocked until family lands · Subclass SwcTiming queued next) · commit 8d181a14 · commit e919c413 (spec page corrected); awaiting re-confirmation
  ...
  - [x] Step 7 — Update checklist comment
  - [x] Step 8 — Deviations: RESOLVED — the TimingDescription family (TimingDescription/TimingDescriptionEvent bases + 23+ concrete TDEvent dispatch targets incl. TDEventSLLETPort) is now fully synced and dispatched in readTimingExtension/readTimingDescriptions + writeTimingExtension (no Rule 0001.10 placeholder remains); all 7 members (timingClocks/timingClockSyncAccuracies/timingConditions/timingDescriptions/timingGuarantees/timingRequirements/timingResource) grounded in XSD TIMING-EXTENSION group
  - [x] REWORK — member order + docstring corrected: timingDescriptions moved to XSD TIMING-EXTENSION sequence position (after timingConditions, before timingGuarantees/timingRequirements/timingResource); timingDescriptions docstring replaced with spec text ("The timing descriptions that belong to a specific timing specification... aggregation marked with stereotype atpVariation") per Table D.65 / XSD group TIMING-EXTENSION; methods reordered to match; NOT yet stamped (9b re-confirm pending)
  - [ ] Step 9 — Verify (9a passed: 454 Timing tests + 2 integration green; ruff/black clean); TYPE FIX applied per user review: timingDescriptions member type corrected from TimingDescriptionEvent → TimingDescription (spec Table D.65 "timingDescription" Type=TimingDescription); 9b re-confirm pending
- [x] SwcTiming (member · markdown · AUTOSAR_CP_TPS_TimingExtensions.md, Table 3.2 · Base includes TimingExtension (queued above) · behaviorRef -> SwcInternalBehavior (BEHAVIOR-REF); XSD COMPONENT-REF atp.Status=removed → not modeled) · commit 8d181a14 · commit e919c413 (spec page corrected); awaiting re-confirmation · commit 048e2e10 · user review: batch-confirmed
  - [x] Step 1 — Sync members & description from spec
  - [x] Step 2 — Write model class unit test (Red)
