...
- [x] PlcaProps (class · Table 3.117 · p.169 · used by CouplingPort.plcaProps · source EthernetTopology.py · resolves ARObject placeholder; attrs plcaLocalNodeId, plcaMaxBurstCount, plcaMaxBurstTimer) · steps complete commit a264fe14 — STAMPED R23-11 — confirmed by user 2026-08-28 <!-- commit: PENDING -->
  - [x] Step 1 — Sync members & description from spec
