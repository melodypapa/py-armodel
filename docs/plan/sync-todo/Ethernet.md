...
- [x] GlobalTimeCouplingPortProps (class · Table 9.18 · p.875 · used by CouplingPortDetails.globalTimeProps · source EthernetTopology.py · Base ARObject; attr propagationDelay TimeValue · resolves ARObject placeholder) · steps complete commit a264fe14 — STAMPED R23-11 — confirmed by user 2026-08-28 <!-- commit: PENDING -->
  - [x] Step 1 — Sync members & description from spec
