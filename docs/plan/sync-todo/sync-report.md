...
| `ApplicationCompositeDataType`                          | [x] Done    | 7fc79e4b                                 | Group2          |
| `ApplicationCompositeElementDataPrototype`              | [x] Done    | 031d5c78                                 | Group2          |
| `ApplicationCompositeElementInPortInterfaceInstanceRef` | [x] Done    | 399b6477                                 | Group2          |
| `ApplicationDataType`                                   | [x] Done    | b8d0878d                                 | Group2          |
| `ApplicationDeferredDataType`                           | [x] Done    | abdfbf1d                                 | Group1          |
| `ApplicationEntry`                                      | [ ] Pending | N/A                                      | Group17         |
| `ApplicationPartitionToEcuPartitionMapping`             | [ ] Pending | N/A                                      | Group18         |
| `ApplicationPrimitiveDataType`                          | [x] Done    | 7fc79e4b                                 | Group2          |
| `ApplicationRecordDataType`                             | [x] Done    | 7fc79e4b                                 | Group2          |
| `ApplicationRecordElement`                              | [x] Done    | 7fc79e4b                                 | Group2          |
...
| `BuildActionInvocator`                                  | [x] Done    | 7008d5e8                                 | Group1          |
| `BuildActionIoElement`                                  | [x] Done    | 209d7e7f                                 | Group1, Group8  |
...
| `ClientIdDefinitionSet`                                 | [x] Done    | 8618ec88                                 | Group5          |
| `ClientIdRange`                                         | [ ] Pending | N/A                                      | Group5, Group15 |
...
| `CompositionSwComponentType`                            | [x] Done    | 7fc79e4b                                 | Group2          |
| `Compu`                                                 | [x] Done    | dac94a9f                                 | Group3          |
| `CompuConst`                                            | [x] Done    | eddddc99                                 | Group3          |
| `CompuConstContent`                                     | [x] Done    | b473f524                                 | Group3          |
| `CompuConstFormulaContent`                              | [x] Done    | 045d6fb5                                 | Group3          |
...
| `CompuScale`                                            | [x] Done    | 057a1039                                 | Group3          |
...
| `ConditionByFormula`                                    | [ ] Pending | 34fbb1c6                                 | Group8          |
...
| `ContainedIPduCollectionSemanticsEnum`                  | [ ] Pending | N/A                                      | Group5, Group15 |
...
| `CouplingPortStructuralElement`                         | [x] Done    | be625387                                 | Group6          |
...
| `DelegationSwConnector`                                 | [x] Done    | 7fc79e4b                                 | Group2          |
...
| `DltContext`                                            | [ ] Pending | N/A                                      | Group5, Group20 |
| `DltDefaultTraceStateEnum`                              | [x] Done    | f1eb819e                                 | Group5          |
| `DltEcu`                                                | [x] Done    | c42f8ae9                                 | Group5          |
...
| `ExternalTriggeringPointIdent`                          | [x] Done    | 7fc79e4b                                 | Group2          |
...
| `FlexrayNmCluster`                                      | [x] Done    | 9c8e10b3                                 | Group6          |
| `FlexrayNmClusterCoupling`                              | [ ] Pending | N/A                                      | Group18         |
| `FlexrayNmEcu`                                          | [x] Done    | 9c8e10b3                                 | Group6          |
| `FlexrayNmNode`                                         | [x] Done    | 9c8e10b3                                 | Group6          |
| `FlexrayPhysicalChannel`                                | [ ] Pending | N/A                                      | Group17         |
| `FrameEnum`                                             | [x] Done    | 531991e0                                 | Group3          |
| `FrameMapping`                                          | [ ] Pending | N/A                                      | Group17         |
| `FramePort`                                             | [x] Done    | 75683a2e                                 | Group5          |
| `FrameTriggering`                                       | [x] Done    | 206cf295                                 | Group5          |
| `FunctionInhibitionNeeds`                               | [x] Done    | 5c4c0963                                 | Group4          |
...
| `LifeCycleInfo`                                         | [ ] Pending | 699c4597                                 | Group8          |
| `LifeCycleInfoSet`                                      | [ ] Pending | 699c4597                                 | Group8          |
| `LifeCyclePeriod`                                       | [ ] Pending | N/A                                      | Group8          |
...
| `MeasuredStackUsage`                                    | [ ] Pending | N/A                                      | Group20         |
| `MemorySection`                                         | [ ] Pending | N/A                                      | Group20         |
...
| `ModeInSwcInstanceRef`                                  | [ ] Pending | 3a64033f                                 | Group8          |
...
| `MsrQueryResultChapter`                                 | [x] Done    | fb505d35                                 | Group3          |
| `MsrQueryResultTopic1`                                  | [x] Done    | 09314bd3                                 | Group3          |
| `MsrQueryTopic1`                                        | [x] Done    | a09f0cdf                                 | Group3          |
| `MultiLanguageParagraph`                                | [x] Done    | 77074563                                 | Group3          |
| `MultidimensionalTime`                                  | [ ] Pending | N/A                                      | Group8          |
...
| `NetworkLayerRule`                                      | [ ] Pending | N/A                                      | Group20         |
...
| `RtePluginProps`                                        | [x] Done    | eee1722                                  | Group6          |
| `RunnableEntityArgument`                                | [x] Done    | 7fc79e4b                                 | Group2          |
...
| `SenderReceiverInterface`                               | [x] Done    | e4e4770f                                 | Group1          |
...
| `ShortNameFragment`                                     | [ ] Pending | N/A                                      | Group8          |
| `ShowContentEnum`                                       | [x] Done    | e89003bb                                 | Group3          |
| `ShowResourceAliasNameEnum`                             | [x] Done    | 3a68e972                                 | Group3          |
| `ShowResourceCategoryEnum`                              | [x] Done    | d7cd8c58                                 | Group3          |
| `ShowResourceLongNameEnum`                              | [x] Done    | 835b8aa1                                 | Group3          |
| `ShowResourceNumberEnum`                                | [x] Done    | 6f562513                                 | Group3          |
| `ShowResourcePageEnum`                                  | [x] Done    | 54f4f3e5                                 | Group3          |
...
| `SoftwareContext`                                       | [ ] Pending | N/A                                      | Group20         |
...
| `SwCalprmAxisSet`                                       | [x] Done    | 9209b83e                                 | Group3          |
...
| `TcpProps`                                              | [ ] Pending | N/A                                      | Group5, Group16 |
...
| `TransportLayerRule`                                    | [ ] Pending | N/A                                      | Group20         |
