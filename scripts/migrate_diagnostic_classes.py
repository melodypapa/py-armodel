#!/usr/bin/env python3
"""
Migrate DiagnosticExtract classes to correct files based on class-package.json.
"""
...
# Get DiagnosticExtract classes
diagnostic_classes = [c for c in data['classes']
                      if 'v2' in c['python_file'] and 'DiagnosticExtract' in c['python_file']]
...
v2_dir = Path('src/armodel/v2/models/M2/AUTOSARTemplates/DiagnosticExtract')
current_files = {}
...
print(f'=== DiagnosticExtract Migration ===')
print(f'Total classes to migrate: {len(diagnostic_classes)}')
