...
Run this from the project root using: python scripts/v2_reader_writer_demo.py
...
from armodel.v2.models.models import AUTOSAR, ARPackage, SwComponentType
...
def demo_read():
    ...
    input_file = Path(__file__).parent.parent / "demo/v2_reader_writer/sample_input.arxml"
...
def demo_write():
    ...
    # Write to file
    output_file = Path(__file__).parent / "v2_demo_output.arxml"
...
def demo_roundtrip():
    ...
    input_file = Path(__file__).parent.parent / "demo/v2_reader_writer/sample_input.arxml"
    temp_file = Path(__file__).parent / "v2_demo_roundtrip.arxml"
