#!/usr/bin/env python3
"""
Migrate SystemTemplate classes to correct files based on class-package.json.
"""
...
# Get SystemTemplate classes
system_classes = [c for c in data['classes']
                  if 'v2' in c['python_file'] and 'SystemTemplate' in c['python_file']]
...
v2_dir = Path('src/armodel/v2/models/M2/AUTOSARTemplates/SystemTemplate')
current_files = {}
...
print(f'=== SystemTemplate Migration ===')
print(f'Total classes to migrate: {len(system_classes)}')
