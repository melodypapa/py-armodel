#!/usr/bin/env python3
"""
Migrate SWComponentTemplate classes to correct files based on class-package.json.
"""
...
# Get SWComponentTemplate classes
swc_classes = [c for c in data['classes']
               if 'v2' in c['python_file'] and 'SWComponentTemplate' in c['python_file']]

# Group by target file
target_files = {}
for cls in swc_classes:
...
v2_dir = Path('src/armodel/v2/models/M2/AUTOSARTemplates/SWComponentTemplate')
current_files = {}
...
print(f'=== SWComponentTemplate Migration ===')
print(f'Total classes to migrate: {len(swc_classes)}')
