...
from armodel.models.M2.AUTOSARTemplates.GenericStructure.AbstractStructure import AtpInstanceRef, AnyInstanceRef, AtpFeature, AtpStructureElement, AtpType
