from armodel.models.M2.AUTOSARTemplates.SystemTemplate.Fibex.Fibex4Ethernet.EthernetCommunication import SocketConnection, SocketConnectionIpduIdentifier, SocketConnectionBundle, SoAdRoutingGroup
