...
from armodel.models.M2.AUTOSARTemplates.SWComponentTemplate.Datatype.DataPrototypes import (
    AtpPrototype, DataPrototype, AutosarDataPrototype, VariableDataPrototype,
    ApplicationCompositeElementDataPrototype, ApplicationArrayElement,
    ApplicationRecordElement, ParameterDataPrototype
)
