...
class TestEcuInstanceHandlers:
    ...
    def test_readEcuInstance_sets_ref_lists(self, parser):
        ...
        element = _snip(
            ...
            "<ASSOCIATED-COM-I-PDU-GROUP-REFS><ASSOCIATED-COM-I-PDU-GROUP-REF DEST='I-SIGNAL-I-PDU-GROUP'>/g0</ASSOCIATED-COM-I-PDU-GROUP-REF></ASSOCIATED-COM-I-PDU-GROUP-REFS>"
            "<ASSOCIATED-CONSUMED-PROVIDED-SERVICE-INSTANCE-GROUPS><CONSUMED-PROVIDED-SERVICE-INSTANCE-GROUP-REF-CONDITIONAL DEST='CONSUMED-PROVIDED-SERVICE-INSTANCE-GROUP'>/g1</CONSUMED-PROVIDED-SERVICE-INSTANCE-GROUP-REF-CONDITIONAL></ASSOCIATED-CONSUMED-PROVIDED-SERVICE-INSTANCE-GROUPS>"
        ...
        assert [r.getValue() for r in instance.getAssociatedComIPduGroupRefs()] == ["/g0"]
    ...
    def test_readEcuInstance_sets_scalars(self, parser):
        ...
        element = _snip(
            ...
            "<TCP-IP-ICMP-PROPS-REF DEST='ETH-TCP-IP-ICMP-PROPS'>/icmp</TCP-IP-ICMP-PROPS-REF>"
            "<TCP-IP-PROPS-REF DEST='ETH-TCP-IP-PROPS'>/tcp</TCP-IP-PROPS-REF>"
